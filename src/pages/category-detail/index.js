...
import {getProductsByCategoryIdAPI, getFiltersAPI, getOtherProductsAPI, filterSortProductsAPI, getSortsAPI} from "../../services/index";
Page({
	data: {
		isLoading: true,
		products: [],
	...
	async loadData(){
		...
		try {
			...
			this.setData({
				products, otherProducts, filters, sorts,
